    ...
    <div style={{ minHeight: '100vh', background: 'transparent', padding: '120px 20px 100px' }}>
      <div className="container" style={{ maxWidth: '1000px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '80px' }}>
          ...
          >
            <div style={{ 
              ...
              borderRadius: '100px', border: '1px solid rgba(79, 70, 229, 0.1)',
              marginBottom: '32px'
            }}>
        ...
        <div style={{ textAlign: 'center', marginTop: '80px' }}>
          <Link to="/dashboard" style={{ color: 'var(--text-muted)', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '10px', fontSize: '0.9rem', fontWeight: '600' }}>
